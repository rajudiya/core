...
{
    const MAGENTOBRAIN_UPDATE_EXTENSION_VERSION_LINK = 'https://www.magentobrain.com/customer/account/login/';
    const MAGENTOBRAIN_PRODUCT_LINK_DEFAULT = 'https://www.magentobrain.com/magento-2-extensions.html';
    const MAGENTOBRAIN_SUPPROT_LINK = 'https://www.magentobrain.com/get-support.html';
    ...
    /**
     * @var \MagentoBrain\Core\Helper\Extensions
     */
    ...
    public function __construct(
        ...
        \MagentoBrain\Core\Helper\Extensions $extensionsHelper,
        array $data = []
    ) {
    ...
    public function render(AbstractElement $element)
    {
        ...
        $modules = $this->extensionsHelper->getMagentoBrainExtensions(true);
    ...
    private function getRenderExtensionLine($extName)
    {
        ...
        $packageData = [];
        $versionOld = false;
        $productUrl = self::MAGENTOBRAIN_UPDATE_EXTENSION_VERSION_LINK;
        ...
        $resultHtml .= '<tr id="magentobrain_core_' . strtolower($extName) . '"><td class="label"><label for="magentobrain_core_' .
            strtolower($extName) . '"><span><a href="' . $productUrl . '" target="_blank">'
            . str_replace('extension', '', str_replace('by MagentoBrain', '', $extInfo['description']))
        ...
        $resultHtml .= '<td class="value">'
            ...
            ($versionOld ?
                ...
                . '<a class="magentobrain-button-get-new-version" href="'
                . self::MAGENTOBRAIN_UPDATE_EXTENSION_VERSION_LINK .
    ...
    {
        $html = '<div class="comment magentobrain-support">';
        $html .= 'Have any issues with <b>MagentoBrain extensions</b>?' .
            ' Please <a href="' . self::MAGENTOBRAIN_SUPPROT_LINK
            . '" class="magentobrain-get-support-button" target="_blank">Contact Support</a>';
